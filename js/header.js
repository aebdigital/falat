            ...
            <div class="nav-container">
                <div class="nav-logo">
                    <a href="${homeLink}" class="logo-link">
                        <img src="${basePath}sources/7648e5eb-8716-4f13-bacc-d24e9d2fcf31-removebg-preview.png" alt="FALAT" class="logo-image">
                    </a>
                </div>
                <ul class="nav-menu">
                    <li><a href="${homeLink}" class="nav-link">Úvod</a></li>
                    <li><a href="${basePath}o-nas" class="nav-link">O nás</a></li>
                    <li><a href="${basePath}galeria" class="nav-link">Galéria</a></li>
                    <li><a href="${basePath}kontakt" class="nav-link">Kontakt</a></li>
                </ul>
                <div class="nav-cta">
                    <a href="tel:+421 907 294 967" class="nav-cta-btn btn_default_wrap">
                        <div class="btn_default_contain">
                            <div class="btn_default_text" data-label="+421 907 294 967" data-alt="+421 907 294 967"></div>
                        </div>
                    </a>
                </div>
                <div class="hamburger">
        ...
        <div class="mobile-sidebar">
            <div class="mobile-sidebar-header">
                <div class="mobile-logo">
                    <a href="${homeLink}" class="mobile-logo-link">
                        <img src="${basePath}sources/7648e5eb-8716-4f13-bacc-d24e9d2fcf31-removebg-preview.png" alt="FALAT" class="logo-image">
                    </a>
                </div>
            ...
            <ul class="mobile-nav-menu">
                ...
                <li><a href="${basePath}galeria" class="mobile-nav-link">Galéria</a></li>
                <li><a href="${basePath}kontakt" class="mobile-nav-link">Kontakt</a></li>
            </ul>
            <div class="mobile-cta">
                <a href="tel:+421907294967" class="mobile-cta-btn">+421 907 294 967</a>
            </div>
        </div>
    `;
...
function updateNavbarBackground() {
    ...
    if (scrollPosition > triggerPoint) {
        ...
        // Active/scrolled logo
        if (logoImage) {
            logoImage.src = `${basePath}sources/a1412b40-41ae-4783-9a32-2ffe1c4b0564-removebg-preview.png`;
        }
    } else {
        transparentNavbar.classList.remove('scrolled');
        // Transparent/not active logo
        if (logoImage) {
            logoImage.src = `${basePath}sources/7648e5eb-8716-4f13-bacc-d24e9d2fcf31-removebg-preview.png`;
        }
    }
}
