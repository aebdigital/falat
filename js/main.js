...
import { initHeader } from './header.js?v=3.0';
import { initFooter } from './footer.js?v=3.0';
import { initSliders } from './slider.js?v=3.0';
import { initAnimations } from './animations.js?v=3.0';
import { initForms } from './forms.js?v=3.0';
import { initPortfolio } from './portfolio.js?v=3.0';
