            ...
            <div class="footer-content">
                <div class="footer-grid">
                    ...
                    <div class="footer-column footer-company">
                        <div class="footer-logo">
                            <img src="${basePath}sources/7648e5eb-8716-4f13-bacc-d24e9d2fcf31-removebg-preview.png" alt="FALAT" class="footer-logo-image">
                        </div>
                        <p class="footer-description">Výroba a montáž nábytku na mieru v Bardejove. Kvalitné riešenia pre domácnosti a firmy.</p>
                        <div class="footer-social">
                            <a href="https://www.facebook.com/FalatFam" target="_blank" class="social-link">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" stroke="currentColor" stroke-width="2"/>
                                </svg>
                            </a>
                            <a href="https://www.instagram.com/falat_fam_s.r.o/" target="_blank" class="social-link">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="footer-column">
                        ...
                        <div class="footer-contact">
                            <div class="contact-item">
                                ...
                                <span>Kacvinského 1, Za OD BILLA<br>085 01 Bardejov</span>
                            </div>
                            <div class="contact-item">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" stroke="currentColor" stroke-width="2"/>
                                </svg>
                                <a href="tel:+421907294967">+421 907 294 967</a>
                            </div>
                            <div class="contact-item">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                                ...
                                <a href="mailto:falat@falat.sk">falat@falat.sk</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer-bottom">
                    <div class="footer-bottom-content">
                        <p>&copy; 2025 FALAT FAM, s.r.o. Všetky práva vyhradené.</p>
                        <div class="footer-links">
                            <a href="#" onclick="openPrivacyPopup(); return false;">Ochrana osobných údajov</a>
                            <a href="https://aebdigital.sk" target="_blank">Tvorba stránky - AEB Digital</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="privacy-popup-content" data-lenis-prevent>
                ...
                <div class="privacy-popup-body">
                    <div class="company-info">
                        <strong>FALAT FAM, s.r.o.</strong><br>
                        <a href="https://maps.google.com/?q=Kacvinsk%C3%A9ho+1,+085+01+Bardejov" target="_blank" rel="noopener" style="text-decoration: underline; color: #F5821E;">Kacvinského 1, Za OD BILLA, 085 01 Bardejov</a><br>
                        Slovenská republika<br>
                        E-mail: falat@falat.sk<br>
                        Tel.: 054/ 472 23 17<br>
                        Mobil: 0907 294 967<br>
                        FAX: 054/ 472 23 17
                    </div>
                    ...
                    <p>Na stránke www.falat.sk prevádzkujeme kontaktný formulár ktorého účelom je umožniť vám:</p>
                    ...
                    <p>V prípade otázok alebo uplatnenia Vašich práv nás môžete kontaktovať na falat@falat.sk alebo telefónnom čísle 0907 294 967.</p>
